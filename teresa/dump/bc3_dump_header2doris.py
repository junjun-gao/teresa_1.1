...
class BC3:
    ...
    def usage() -> None:
        ...
        print("INFO    : @(#)BC3 for Doris, Author: Yuxiao")
        print("\n")
        print("Usage   : python bc3_dump_header2doris.py metafile")  # nopep8
        print("          - `metafile` is the BC3 meta file in xml format.")
        print("\n")
...
def bc3_dump_header2doris(source_meta_path, work_dir):
    ...
    with open(result_file, "w") as f:
        with redirect_stdout(f):
            ...
            print()
            print("bc3_dump_header2doris.py v1.0, doris software, 2024")
